"""
Everything specific to Aya Expanse lives here. Its chat template
supports a system role natively -- identical mechanics to Qwen, kept as
its own file so any future Aya-specific quirk has an obvious home.
"""
